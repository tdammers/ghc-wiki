...
- Template Haskell for cross compilers! Could be done by (in order of increasing complexity):
  ...
  - Evil Splicer [
    ...
    http://hackage.haskell.org/package/zeroth](http://hackage.haskell.org/package/zeroth) (The most recently maintained repository is Adam Vogts fork of [
    https://github.com/mgsloan/zeroth](https://github.com/mgsloan/zeroth))
  - A less powerful template-haskell extension
  - stage 2 in cross compilers
  - Using the Out-Of-Process TH strategy that ghcjs uses. (work underway by angerman, see [
    https://github.com/angerman/oopth](https://github.com/angerman/oopth))
...
- Programs outputting substantial text to the console can cause hangs in the RTS. (fixed by lukexi in ticket [\#8307](http://gitlabghc.nibbler/ghc/ghc/issues/8307)).
