...
<table><tr><th>[\#9112](http://gitlabghc.nibbler/ghc/ghc/issues/9112)</th>
<td>support for deriving Vector/MVector instances</td></tr>
<tr><th>[\#9118](http://gitlabghc.nibbler/ghc/ghc/issues/9118)</th>
...
<tr><th>[\#13358](http://gitlabghc.nibbler/ghc/ghc/issues/13358)</th>
<td>Role ranges (allow decomposition on newtypes)</td></tr>
<tr><th>[\#14292](http://gitlabghc.nibbler/ghc/ghc/issues/14292)</th>
...
<tr><th>[\#14362](http://gitlabghc.nibbler/ghc/ghc/issues/14362)</th>
<td>Allow: Coercing (a:\~:b) to (b:\~:a)</td></tr>
<tr><th>[\#14386](http://gitlabghc.nibbler/ghc/ghc/issues/14386)</th>
<td>GHC doesn't allow Coercion between partly-saturated type constructors</td></tr>
<tr><th>[\#14694](http://gitlabghc.nibbler/ghc/ghc/issues/14694)</th>
<td>Incompleteness in the Coercible constraint solver</td></tr>
<tr><th>[\#15441](http://gitlabghc.nibbler/ghc/ghc/issues/15441)</th>
<td>Data type with phantoms using TypeInType isn't coercible</td></tr>
<tr><th>[\#15707](http://gitlabghc.nibbler/ghc/ghc/issues/15707)</th>
...
<table><tr><th>[\#8246](http://gitlabghc.nibbler/ghc/ghc/issues/8246)</th>
<td>Role annotations does not allow the use of parenthesis</td></tr>
<tr><th>[\#9117](http://gitlabghc.nibbler/ghc/ghc/issues/9117)</th>
...
<tr><th>[\#9131](http://gitlabghc.nibbler/ghc/ghc/issues/9131)</th>
<td>Experiment with a dedicated solver for Coercible</td></tr>
<tr><th>[\#10905](http://gitlabghc.nibbler/ghc/ghc/issues/10905)</th>
<td>Incorrect number of parameters in "role" errors</td></tr>
<tr><th>[\#11230](http://gitlabghc.nibbler/ghc/ghc/issues/11230)</th>
...
<tr><th>[\#14101](http://gitlabghc.nibbler/ghc/ghc/issues/14101)</th>
...
<tr><th>[\#14363](http://gitlabghc.nibbler/ghc/ghc/issues/14363)</th>
<td>:type hangs on coerce</td></tr>
<tr><th>[\#15294](http://gitlabghc.nibbler/ghc/ghc/issues/15294)</th>
<td>Unused "foralls" prevent types from being Coercible</td></tr>
<tr><th>[\#15431](http://gitlabghc.nibbler/ghc/ghc/issues/15431)</th>
...
GHC has had a hole in its type system for several years, as documented in [\#1496](http://gitlabghc.nibbler/ghc/ghc/issues/1496), [\#4846](http://gitlabghc.nibbler/ghc/ghc/issues/4846), [\#5498](http://gitlabghc.nibbler/ghc/ghc/issues/5498), and [\#7148](http://gitlabghc.nibbler/ghc/ghc/issues/7148). The common cause behind all of this is the magic behind `-XGeneralizedNewtypeDeriving` (GND). Here is an example:
