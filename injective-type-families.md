...
This page summarizes the design of injective type families ([\#6018](http://gitlabghc.nibbler/ghc/ghc/issues/6018)).
...
[\#10832](http://gitlabghc.nibbler/ghc/ghc/issues/10832). See
[
...
Other tickets related to further development of injective type families: [\#10833](http://gitlabghc.nibbler/ghc/ghc/issues/10833), [\#11511](http://gitlabghc.nibbler/ghc/ghc/issues/11511).
...
<tr><th>[\#10227](http://gitlabghc.nibbler/ghc/ghc/issues/10227)</th>
...
<tr><th>[\#13621](http://gitlabghc.nibbler/ghc/ghc/issues/13621)</th>
<td>Problems with injective type families</td></tr>
<tr><th>[\#13797](http://gitlabghc.nibbler/ghc/ghc/issues/13797)</th>
<td>Mark negation injective</td></tr>
<tr><th>[\#14164](http://gitlabghc.nibbler/ghc/ghc/issues/14164)</th>
...
<table><tr><th>[\#6018](http://gitlabghc.nibbler/ghc/ghc/issues/6018)</th>
...
<tr><th>[\#12430](http://gitlabghc.nibbler/ghc/ghc/issues/12430)</th>
...
<tr><th>[\#13651](http://gitlabghc.nibbler/ghc/ghc/issues/13651)</th>
...
<tr><th>[\#14369](http://gitlabghc.nibbler/ghc/ghc/issues/14369)</th>
...
The idea behind [\#6018](http://gitlabghc.nibbler/ghc/ghc/issues/6018) is to allow users to declare that a type family is
...
didn't finish it. The relevant Trac ticket is [\#10832](http://gitlabghc.nibbler/ghc/ghc/issues/10832). Partial implementation
is available as [
...
1. GHC has an outright bug in its handling of consistency,
  ...
  See Trac [\#10675](http://gitlabghc.nibbler/ghc/ghc/issues/10675).
...
[Here](http://gitlabghc.nibbler/ghc/ghc/issues/6018) it was suggested by Simon that we could infer
