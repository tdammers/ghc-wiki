...
This is currently rejected by GHC 8.0 RC1 ([\#11466](http://gitlabghc.nibbler/ghc/ghc/issues/11466)), but would achieve the same user-facing goal of hiding the implicit parameter.
