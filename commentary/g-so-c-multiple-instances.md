...
- `ZZZZ` is not uniquely determined by the compilation inputs (see [\#4012](http://gitlabghc.nibbler/ghc/ghc/issues/4012)), although in the future we hope it will be
