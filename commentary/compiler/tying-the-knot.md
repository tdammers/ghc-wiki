...
<table><tr><th>[\#1012](http://gitlabghc.nibbler/ghc/ghc/issues/1012)</th>
...
<table><tr><th>[\#2412](http://gitlabghc.nibbler/ghc/ghc/issues/2412)</th>
<td>Interaction between type synonyms and .hs-boot causes panic "tcIfaceGlobal (local): not found"</td></tr>
<tr><th>[\#4003](http://gitlabghc.nibbler/ghc/ghc/issues/4003)</th>
<td>tcIfaceGlobal panic building HEAD with 6.12.2</td></tr>
<tr><th>[\#7672](http://gitlabghc.nibbler/ghc/ghc/issues/7672)</th>
...
<tr><th>[\#10083](http://gitlabghc.nibbler/ghc/ghc/issues/10083)</th>
...
<tr><th>[\#12035](http://gitlabghc.nibbler/ghc/ghc/issues/12035)</th>
<td>hs-boot knot tying insufficient for ghc --make</td></tr>
<tr><th>[\#12042](http://gitlabghc.nibbler/ghc/ghc/issues/12042)</th>
<td>Infinite loop with type synonyms and hs-boot</td></tr>
<tr><th>[\#12064](http://gitlabghc.nibbler/ghc/ghc/issues/12064)</th>
<td>tcIfaceGlobal error with existentially quantified types</td></tr>
<tr><th>[\#13140](http://gitlabghc.nibbler/ghc/ghc/issues/13140)</th>
<td>Handle subtyping relation for roles in Backpack</td></tr>
<tr><th>[\#13591](http://gitlabghc.nibbler/ghc/ghc/issues/13591)</th>
<td>"\*\*\* Exception: expectJust showModule" in ghci with hs-boot</td></tr>
<tr><th>[\#13710](http://gitlabghc.nibbler/ghc/ghc/issues/13710)</th>
<td>panic with boot and -jX</td></tr>
<tr><th>[\#13803](http://gitlabghc.nibbler/ghc/ghc/issues/13803)</th>
<td>Panic while forcing the thunk for TyThing IsFile (regression)</td></tr>
<tr><th>[\#14075](http://gitlabghc.nibbler/ghc/ghc/issues/14075)</th>
<td>GHC panic with parallel make</td></tr>
<tr><th>[\#14080](http://gitlabghc.nibbler/ghc/ghc/issues/14080)</th>
<td>GHC panic while forcing the thunk for TyThing IsFile (regression)</td></tr>
<tr><th>[\#14396](http://gitlabghc.nibbler/ghc/ghc/issues/14396)</th>
<td>Hs-boot woes during family instance consistency checks</td></tr>
<tr><th>[\#14531](http://gitlabghc.nibbler/ghc/ghc/issues/14531)</th>
