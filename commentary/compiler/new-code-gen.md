...
- Bug list (code-gen related bugs that we may be able to fix):
  ...
  - [\#1498](http://gitlabghc.nibbler/ghc/ghc/issues/1498) (avoid redundant heap check on the fast path)
  - [\#3552](http://gitlabghc.nibbler/ghc/ghc/issues/3552) (unreachable code)
  - [\#3462](http://gitlabghc.nibbler/ghc/ghc/issues/3462) (a feature)
  - [\#2249](http://gitlabghc.nibbler/ghc/ghc/issues/2249)
  - [\#2253](http://gitlabghc.nibbler/ghc/ghc/issues/2253)
  - [\#2289](http://gitlabghc.nibbler/ghc/ghc/issues/2289)
  - [\#7219](http://gitlabghc.nibbler/ghc/ghc/issues/7219) (reinstate constant-prop)
  - [\#7213](http://gitlabghc.nibbler/ghc/ghc/issues/7213) (massive array)
