...
we faced some performance issues. Hence, we created the task [\#11528](http://gitlabghc.nibbler/ghc/ghc/issues/11528) to further investigate whether such
...
the case already in GHC though (see ticket [\#8494](http://gitlabghc.nibbler/ghc/ghc/issues/8494)).
