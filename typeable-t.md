...
There is [\#11011](http://gitlabghc.nibbler/ghc/ghc/issues/11011) for discussion of this proposal.
...
- A related ticket: [7897](http://gitlabghc.nibbler/ghc/ghc/issues/7897) (MakeTypeRep fingerprints be proper, robust fingerprints) describes a situation where the data type can change, but the fingerprint remains the same (as it is a hash of "\<package-key\> \<module\> \<type name\>"), but it only really affects the main package.
