#
Class Method Deprecations ([\#10071](http://gitlabghc.nibbler/ghc/ghc/issues/10071))
...
This would aid long-term transitions like phasing out class-methods, such as e.g. `Monad(return)` in the spirit of [\#4834](http://gitlabghc.nibbler/ghc/ghc/issues/4834):
